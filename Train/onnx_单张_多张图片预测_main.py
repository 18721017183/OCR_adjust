...
if __name__ == '__main__':
    ...
    image_path = r'C:\Users\pc\Desktop\img\ocr_all'
    ...
    parser.add_argument('--onnx_model',default="./torch_model_train_Acc100.000_test_Acc99.375.onnx",help='the onnx_model to predict')
