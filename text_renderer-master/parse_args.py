...
def parse_args():
    ...
    #parser.add_argument('--output_dir', type=str, default='../Train/data/lv_make_image', help='Images save dir')      #ocr训练目录，实际使用时可以直接保存至训练目录
    #图片生成的文件夹,         **需要选择train/test**
    parser.add_argument('--tag', type=str, default='train1', help='output images are saved under output_dir/{tag} dir')   #train/test
